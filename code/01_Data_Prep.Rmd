...
Two teams submitted two different result sets,  therefore,  we need to give them unique team identifiers for the analytical phase. Although these are obvious errors, we wanted to preserve the ecological validity of the researchers' research process and did not intervene or ask them to submit just one set of results.
