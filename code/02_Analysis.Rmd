...
## What predicts replication results?
...
```{r regs}
# original - pooled
O_1 <- lm(exact_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team_orig)
O_2 <- lm(verif_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team_orig)
O_3 <- lm(dev_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team_orig)
...
# curated - pooled
M_1 <- lm(exact_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team)
M_2 <- lm(verif_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team)
M_3 <- lm(dev_m ~ stata + stat_skill + difficult + factor(degree) + exp, data = cri_team)
