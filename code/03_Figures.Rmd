...
agg_png(filename = here::here("results","Fig2.png"), res = 144, width = 500, height = 400)
fig1_plot %>%
  ...
  annotate("label", x = 98.5, y = 15.5, label = reps, color = "grey40", size = 2.75, hjust = 0, fill = "white", family = "Times New Roman") +
  ...
  # P labels
  annotate("label", x = 83, y = 9, label = P99, color = "#3CBB75FF", fill = "white", family = "Times New Roman", size = 2.5) +
  annotate("label", x = 82, y = 6, label = P95, color = "#287D8EFF", fill = "white", family = "Times New Roman", size = 2.5) +
  annotate("label", x = 80.5, y = 2.75, label = P90, color = "#453781FF", fill = "white", family = "Times New Roman", size = 2.5) +
    scale_x_reverse() +
  ...
  theme(text = element_text(family = "Times New Roman", size = 8),
        axis.title.x = element_text(family = "Times New Roman", size = 9, margin = margin(t = 18)),
...
fig3t$se <- fig3t$verif_fn2/sqrt(1874)
...
fig3bt$se <- (fig3bt$verif_fn2/sqrt(1874))
...
## OLD Figure 2. Comparing Replication Outcomes

### Part A. Effect-Level

```{r fig2prepa, warning = F, message = F}
...
f2colors3 <- c("#2D708EFF", "#95D840FF", "#2D708EFF", "#95D840FF", "#2D708EFF", "#95D840FF", "#2D708EFF", "#95D840FF")
...
fig2a <- ggplot(data = fig2) +
  ...
  geom_richtext(aes(x = 7, y = 37, label = "<p style = 'font-size:10px; text-align:justify'><i>(within 0.01)</i></p>"), 
                angle = 90, fill = NA, label.color = NA, family = "Times") +
  geom_text(aes(y = result - c(7,7,7,7,7,-7,7,-7), x = c(1,2,3,4,5.5,6.5,7.5,8.5), label = fig2$result), family = "Times") +
...
### NEW Figure 2. Comparing Replication Outcomes

#### Fig2aN Raw Effect-Level Results
```{r fig2new}
...
fig2aN <- ggplot(data = fig2t[c(1,2,5,6),]) +
  ...
  scale_fill_manual(values = f2colors3,
                    guide = guide_legend(reverse = TRUE)) +
  geom_text(aes(y = 100, x = c(2,3,5,6),                 
                label = round(fig2t$result[c(1,2,5,6)],1)), 
            family = "Times",
            #hjust = 1,
            size = 5) + 
  theme_classic() +
  ...
  coord_flip(xlim = c(6.5,1), ylim = c(25,100),  clip = "on") +
  scale_x_reverse() +
  annotate("text", x = c(1.2,4.2), y = c(22, 22), 
           label = c("VERIFICATION (same sign)", "EXACT REPLICATION (within 0.01)"), 
           hjust = 0, 
           size = 5, 
           fontface = "italic", 
           color = "gray30") +
  annotate("text", x = c(2,3,5,6), y = c(23, 23, 23, 23), 
...
fig2bN <- ggplot(data = fig2bt[c(1,2,5,6),]) +
  ...
  scale_fill_manual(values = f2colors3,
                    guide = guide_legend(reverse = TRUE)) +
  geom_text(aes(y = 100, x = c(2,3,5,6),                 
                label = round(fig2bt$result[c(1,2,5,6)],1)), 
            family = "Times",
            hjust = 1, size = 5) + 
  theme_classic() +
  ...
  coord_flip(xlim = c(6.5,1), ylim = c(5,100),  clip = "on") +
  scale_x_reverse() +
  annotate("text", x = c(1.2,4.2), y = c(0, 0), 
           label = c("VERIFICATION (95%+ of team results)", "EXACT REPLICATION (95%+ of team results)"), 
           hjust = 0, 
           size = 5, 
           fontface = "italic", 
           color = "gray30") +
  annotate("text", x = c(2,3,5,6), y = c(2, 2, 2, 10), 
           label = c("TG", "OG", "TG", "OG"),
           hjust = 0, 
           size = 5) +
  theme_classic() +
...
```
#### Fig2aN_dev Deviance Raw Effect-Level

```{r fig2newc}
f2colors32 <- c("#2D708EFF", "#95D840FF") 

fig2aN_dev <- ggplot(data = fig3t[c(1,2),]) +
  
  coord_flip() +
  geom_errorbar(aes(ymin = result-(2.58*se), ymax = result+(2.58*se), x = c(2,3),), color = "grey30", width = 0.3) +
  geom_point(aes(y = result, x = c(2,3), color = interaction(group, version)), size = 5) +
  scale_x_reverse() +
  ...
  geom_text(aes(y = 0.1, x = c(2,3),                 
            ...
            size = 5) + 
  theme_classic() +
  ylab("Average of Absolute Differences") +
  xlab(" ") +
  #labs(title = "A. Raw Effect-Level Results, N = 3,742") +
...
```
#### Fig2bN_dev Deviance Raw Team-Level

```{r fig2newd}
f2colors32 <- c("#2D708EFF", "#95D840FF")

fig2bN_dev <- ggplot(data = fig3bt[c(1,2),]) +
...
```{r fig2bout, warning = F, message = F}
...
fig2bb <- ggplot(data = fig2b) +
  ...
  # add ICC to plot
  # title
  annotate("text", x = 0.7, y = 92, parse = T, label = expression(paste("Between ", sigma^{2})), size = 3, color = "grey20", family = "Times") +
  annotate("text", x = 1, y = 92, label = paste0(round(icc_out$percent[1],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 2, y = 92, label = paste0(round(icc_out$percent[2],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 3, y = 92, label = paste0(round(icc_out$percent[3],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 4, y = 92, label = paste0(round(icc_out$percent[4],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 5.5, y = 92, label = paste0(round(icc_out$percent[5],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 6.5, y = 92, label = paste0(round(icc_out$percent[6],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 7.5, y = 92, label = paste0(round(icc_out$percent[7],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 8.5, y = 92, label = paste0(round(icc_out$percent[8],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  # add percentages
  geom_text(aes(y = result - c(7,7,7,7,7,-6,7,-7), x = c(1,2,3,4,5.5,6.5,7.5,8.5), label = fig2b$result), family = "Times") +
  ylab("Percent of Replicating Teams") +
  xlab(" ") +
...
ggarrange package doesn't deal with Times New Roman very well.

```{r fig2final, eval = F}
agg_png(here::here("results","Fig1.png"), width = 1300, height = 800, res = 144)
...
```{r ddeviance_fig2effect, warning = F, message = F}
agg_png(here::here("results","Fig1c1.png"), height = 350, width = 475, res = 144)
...
fig2c1 <- ggplot(data = fig3) +
  ...
  geom_richtext(aes(x = 2.5, y = 0.044, label = "<p style = 'font-size:10px; text-align:justify'><i>(abs. difference)<i></p>"), 
                angle = 90, fill = NA, label.color = NA, family = "Times") +
  geom_text(aes(y = result - c(0.007,0.01,-0.007,0.007), x = c(1,2,3,4), label = round(fig3$result,3)), family = "Times") +
...
knitr::include_graphics(here::here("results","Fig1c1.png"))
```


### Fig 1C Team-Level

```{r deviance_fig2, warning = F, message = F}
agg_png(here::here("results","Fig1c2.png"), height = 350, width = 475, res = 144)
fig2c2 <- ggplot(data = fig3b) +
  ...
  geom_richtext(aes(x = 2.5, y = 0.045, label = "<p style = 'font-size:10px; text-align:justify'><i>(between team avg.)<i></p>"), 
                angle = 90, fill = NA, label.color = NA, family = "Times") +
  geom_text(aes(y = result - c(0.007,0.012,-0.007,0.0085), x = c(1,2,3,4), label = round(fig3b$result,3)), family = "Times") +
  ...
  # add ICC to plot
  annotate("text", x = 1, y = 0.085, label = paste0(round(icc_out$percent[9],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 2, y = 0.085, label = paste0(round(icc_out$percent[10],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 3, y = 0.085, label = paste0(round(icc_out$percent[11],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
  annotate("text", x = 4, y = 0.085, label = paste0(round(icc_out$percent[12],0),"%"), size = 3, hjust = 0, color = "grey20", family = "Times") +
...
knitr::include_graphics(here::here("results","Fig1c2.png"))
```
...
desc <- as.data.frame(matrix(nrow = 38, ncol = 8))
...
desc[4,3:5] <- c(39,46,85)
desc[5:8,3] <- as.numeric(c(t(cri_long_pool_t[1,1:3]),cri_long_pool_t[1,9]))
desc[5:8,4] <- as.numeric(c(t(cri_long_pool_o[1,1:3]),cri_long_pool_o[1,9]))
desc[5:8,5] <- as.numeric(c(t(cri_long_pool[1,1:3]),cri_long_pool[1,9]))

desc[10,3:5] <- c(37,44,81)
desc[11:14,3] <- as.numeric(c(t(cri_long_trim_pool_t[1,1:3]),cri_long_trim_pool_t[1,9]))
desc[11:14,4] <- as.numeric(c(t(cri_long_trim_pool_o[1,1:3]),cri_long_trim_pool_o[1,9]))
desc[11:14,5] <- as.numeric(c(t(cri_long_trim_pool[1,1:3]),cri_long_trim_pool[1,9]))

desc[16,3:5] <- c(39,46,85)
desc[17:20,3] <- as.numeric(c(t(cri_long_cur_pool_t[1,1:3]),cri_long_cur_pool_t[1,9]))
desc[17:20,4] <- as.numeric(c(t(cri_long_cur_pool_o[1,1:3]),cri_long_cur_pool_o[1,9]))
desc[17:20,5] <- as.numeric(c(t(cri_long_cur_pool[1,1:3]),cri_long_cur_pool[1,9]))
