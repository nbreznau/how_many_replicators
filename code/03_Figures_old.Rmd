...
agg_png(filename = here::here("results","Fig1_old.png"), res = 144, width = 1000, height = 700)
fig1_plot %>%
...
knitr::include_graphics(here::here("results","Fig1_old.png"))
```
...
#### Produce Fig2a
```{r fig2out}
agg_png(here::here("results","Fig2a_old.png"), height = 700, width = 650, res = 144)
...
knitr::include_graphics(here::here("results","Fig2a_old.png"))
```
### Part B. ICC
...
agg_png(here::here("results","Fig2b_old.png"), height = 700, width = 475, res = 144)
...
knitr::include_graphics(here::here("results","Fig2b_old.png"))
```
### Figure 2 Combined
...
```{r fig2final, eval = F}
agg_png(here::here("results","Fig2_old.png"), width = 1300, height = 800, res = 144)
ggarrange(fig2a,fig2bb, ncol = 2, nrow = 1, widths = c(1.4,1))
dev.off()

knitr::include_graphics(here::here("results", "Fig2_old.png"))
```

### Fig 2C Effect-Level

```{r ddeviance_fig2effect, warning = F, message = F}
agg_png(here::here("results","Fig2c1_old.png"), height = 350, width = 475, res = 144)
...
knitr::include_graphics(here::here("results","Fig2c1_old.png"))
```
...
agg_png(here::here("results","Fig2c2_old.png"), height = 350, width = 475, res = 144)
...
knitr::include_graphics(here::here("results","Fig2c2_old.png"))
```
...
desc[3:31,6] <- c(sum(!is.na(cri_long$verif[cri_long$Exp1 == 1])),"", 
...
desc[3:31,7] <- c(sum(!is.na(cri_long$verif[cri_long$Exp1 == 0])),"", 
...
desc[3:31,8] <- c(sum(!is.na(cri_long$verif)),"", 
...
desc[10:13,5] <- as.numeric(c(t(cri_long_cur_pool[1,1:3]),cri_long_cur_pool[1,9]))
desc[10:13,3] <- as.numeric(c(t(cri_long_cur_pool_t[1,1:3]),cri_long_cur_pool_t[1,9]))
desc[10:13,4] <- as.numeric(c(t(cri_long_cur_pool_o[1,1:3]),cri_long_cur_pool_o[1,9]))
