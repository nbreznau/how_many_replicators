...
xl <- expression(paste("Binamial Probability that A Single Replication is Accurate (", italic("p"), ")", sep = ""))
...
fig1_plot %>%
  ...
  annotate("text", x = 97, y = 13, label = reps, color = "grey40", size = 3, hjust = 0) +
  scale_x_reverse() +
  geom_curve(
