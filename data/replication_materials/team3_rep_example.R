pacman::p_load("readxl","readr","tidyr","dplyr","stringr",
               "lubridate","ggplot2","texreg","haven","plm","broom")

countryData <- read_dta(here::here("data","replication_materials","bradyfinnigan2014countrydata.dta"))
issp1996 <- read_dta(here::here("data","replication_materials","ZA2900.dta"))
issp2006 <- read_dta(here::here("data","replication_materials","ZA4700.dta"))
...
rm(issp1996,issp2006,issp1996_recode,issp2006_recode,countryData_recode)


# subset
tomodel <- issp9606 %>% filter(cntry %in% c(36, 124, 250, 276, 372, 392, 554, 578, 724, 752, 756, 826, 840))

# Here the PIs saved the analysis dataframe to be tested by Team 12's code
saveRDS(tomodel, file = here::here("data","replication_materials","tomodel.RDS"))
...
# save output as html (htmlreg) and then import to excel
htmlreg(l = list(m4.base[[1]], m4.base[[2]], m4.base[[3]], m4.base[[4]], m4.base[[5]], m4.base[[6]]                       
        ...
        , file = here::here("data","replication_materials","team3_table4.html")
        , digits = 3
          )
...
, file = here::here("data","replication_materials","team3_table5.html")
, digits = 3
)
